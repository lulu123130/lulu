...
/**
 * @description 分页接口（前台）(论坛)
 * @param { string } tableName 表名
 */
export function getForumDetailAPI(tableName, id) {
  return http({
 ...
 * @description 分页接口（前台）(论坛)
 */
export function getForumListAPI(tableName, params = {}) {
  return http({
    url: tableName + '/flist',
    method: 'get',
    params: {
 ...
 * @param { string } tableName 表名
 */
export function getListsAPI(tableName, params) {
  return http({
    url: tableName + '/lists',
    method: 'get',
    params
